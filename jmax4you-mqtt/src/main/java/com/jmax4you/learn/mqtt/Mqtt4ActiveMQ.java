 ...
 */
public class Mqtt4ActiveMQ {

    static String clientId = "2";
    static String username = "2";
    static String password = "e6da68330d0e4564";

    public static void main(String[] args) {
        String topic = "maxTopic";
        String content = "Message from MqttPublishSample";
        int qos = 0;
        String broker = "tcp://192.168.218.240:1883";
        ...
        try {
            ...
            sampleClient.setCallback(new ActiveMQDataCallBack());
...
class ActiveMQDataCallBack implements MqttCallback {
    @Override
